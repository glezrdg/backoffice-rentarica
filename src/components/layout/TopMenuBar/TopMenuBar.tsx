  ...
  return (
    <div className='flex items-center justify-between h-[70px] px-5 bg-white '>
      <div className='flex items-center'>
        <i className='fa fa-bars cursor-pointer lg:text-2xl mr-4 text-slate-400' />
        <h1 className='font-mono text-2xl text-slate-600'>BuenoDev</h1>
      </div>
      <div className='w-[600px] border p-3 rounded-lg box-border transition hover:shadow-sm'>
        <i className='fa fa-thing fa-magnifying-glass mr-2 text-slate-400' />
        <input
          placeholder='Buscar...'
          className='outline-none w-[95%] text-slate-500 placeholder:italic placeholder:text-slate-400 '
        />
      </div>
      <div className='w-[180px] flex justify-between'>
        ...
        >
          <i className='text-xl fa fa-thin fa-envelope text-slate-400'></i>
        ...
        >
          <i className='text-xl fa fa-sharp fa-light fa-bell text-slate-400'></i>
          <div className='absolute top-0 left-[38%]'>
            <span className='relative flex h-2 w-2'>
        ...
        <div className='relative cursor-pointer hover:bg-slate-50 px-2 py-1 rounded-full'>
          <i className='text-xl fa fa-light fa-gear text-slate-400'></i>
        </div>
        {/* Profile */}
        <div
          ...
          className='relative cursor-pointer hover:bg-slate-50 px-2 py-1 rounded-full'
        >
          <i className='text-xl fa fa-light fa-user text-slate-400'></i>
